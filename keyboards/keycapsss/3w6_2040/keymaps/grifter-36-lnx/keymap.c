...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE] = LAYOUT_split_3x5_3(
            ...
            KC_A, KC_S, KC_D, KC_F, KC_G,               KC_H, KC_J, KC_K, KC_L, OSM(MOD_RALT),
            KC_Y, KC_X, KC_C, KC_V, KC_B,               KC_N, KC_M, KC_COMM, KC_DOT, OSM(MOD_RCTL),
                        MO(1), MO(2), KC_LSFT,      KC_SPC, MO(3), MO(4)),

	[_NUM] = LAYOUT_split_3x5_3(
            KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                                      KC_EQL, KC_7, KC_8, KC_9, KC_PLUS,
            OSM(MOD_LSFT), OSM(MOD_LGUI), OSM(MOD_LALT), OSM(MOD_LCTL), KC_NO,      KC_ASTR, KC_4, KC_5, KC_6, KC_MINS,
            KC_NO, KC_NO, OSM(MOD_RALT), KC_NO, KC_NO,                                      KC_0, KC_1, KC_2, KC_3, KC_SLSH,
                        KC_TRNS, KC_TRNS, KC_NO,                                KC_NO, KC_TRNS, KC_NO),

	[_EXT] = LAYOUT_split_3x5_3(
            KC_NO, LCTL(KC_B) ,KC_NO, CLEAR_OSM, KC_NO,                                KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_INS,
            OSM(MOD_LSFT), OSM(MOD_LGUI), OSM(MOD_LALT), OSM(MOD_LCTL), KC_NO,     KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_DEL,
            LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), KC_ENT,                     KC_ESC, KC_BSPC, KC_TAB, KC_NO, KC_NO,
                        KC_NO, KC_TRNS, KC_NO,                                  KC_NO, KC_TRNS, KC_NO),

	[_SYM] = LAYOUT_split_3x5_3(
            KC_EXLM, KC_QUES, LSA(KC_2), KC_AMPR, KC_GRV,                           KC_NO, KC_AT, KC_DLR, KC_HASH, KC_NO,
            OSM(MOD_LSFT), OSM(MOD_LGUI), OSM(MOD_LALT), OSM(MOD_LCTL), KC_DQUO,    KC_LPRN, KC_LCBR, KC_LBRC, KC_PIPE, KC_COLN,
            KC_PERC, KC_TILD, KC_CIRCUMFLEX, KC_NO, KC_QUOT,                                KC_RPRN, KC_RCBR, KC_RBRC, KC_BSLS, KC_SCLN,
